...
This is the kind of morning we had in mind when we wrote about <a href={withBase("/journal/the-art-of-the-slow-weekend")}>the slow weekend</a> — the one that starts before anyone else is awake, and sets the tone for everything that follows.

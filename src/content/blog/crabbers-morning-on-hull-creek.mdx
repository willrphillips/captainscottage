...
What goes back: anything undersized, and any immature females (you can tell them by the narrow apron on the underside of the shell). Virginia recreational rules are simple and easy to read before your stay at [mrc.virginia.gov](https://mrc.virginia.gov/regulations/VA-recreational-crabbing-rules.shtm). A quick scan of <a href={withBase("/what-to-bring")}>what to bring</a> will also remind you: rubber gloves and a bucket are all you need — we keep the pot and line on the dock.
